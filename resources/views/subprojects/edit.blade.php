...
@section('heading', 'Edit List')
@section('subheading', 'Perbarui informasi list')
...
<div class="max-w-2xl mx-auto">
    <div class="bg-white border border-slate-200 rounded-2xl p-8 shadow-sm">
        <form method="POST" action="{{ route('subprojects.update', $subproject->id) }}" class="space-y-5"
            ...
            <div>
                <label class="block text-sm font-medium text-slate-700 mb-2">Program Induk <span class="text-red-600">*</span></label>
            ...
            <div>
                <label class="block text-sm font-medium text-slate-700 mb-2">Nama List <span class="text-red-600">*</span></label>
            ...
            <div>
                ...
                <textarea name="description" rows="4" placeholder="Deskripsi list (opsional)"
