...
<div class="max-w-2xl mx-auto space-y-6">
    <div>
        ...
        <h1 class="text-2xl font-bold text-slate-800">Tambah Unit Kerja</h1>
    </div>
        ...
        <form action="{{ route('unit-kerja.store') }}" method="POST" class="space-y-5">
            ...
            <div>
                ...
                <input type="text" name="name" value="{{ old('name') }}"
                       ...
                       placeholder="contoh: Dinas Pertanian Kota">
            ...
            <div>
                ...
                <input type="text" name="code" value="{{ old('code') }}"
                       ...
                       placeholder="contoh: DINTAN" style="text-transform:uppercase">
                <p class="text-xs text-slate-400 mt-1">Kode singkat unik, huruf kapital, tanpa spasi</p>
            ...
            <div>
                ...
                <textarea name="description" rows="3"
                          class="w-full px-4 py-2.5 rounded-xl border border-slate-200 focus:border-blue-400 focus:ring-2 focus:ring-blue-100 outline-none text-sm transition-colors resize-none"
                          placeholder="Deskripsi singkat unit kerja ini...">{{ old('description') }}</textarea>
            </div>
