...
<div class="max-w-lg mx-auto">
    <div class="bg-white border border-slate-200 rounded-2xl p-8 shadow-sm">
        <form method="POST" action="{{ route('users.update', $user->id) }}" class="space-y-5">
            ...
            <div>
                <label class="block text-xs font-semibold text-slate-700 uppercase tracking-wider mb-2">Password Baru <span class="text-slate-400 font-normal normal-case">(Kosongkan jika tidak ingin diubah)</span></label>
